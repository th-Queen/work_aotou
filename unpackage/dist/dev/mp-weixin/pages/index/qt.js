...
const _sfc_main = {
  ...
  methods: {
    ...
    async publishTask() {
      common_vendor.index.__f__("log", "at pages/index/qt.vue:196", "taskName:", this.taskName);
      if (!this.canPublish)
        return;
      ...
      common_vendor.index.__f__("log", "at pages/index/qt.vue:217", "完整的 taskData:", JSON.stringify(taskData, null, 2));
      try {
        ...
        common_vendor.index.__f__("error", "at pages/index/qt.vue:225", "API错误", error);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    C: common_vendor.o((...args) => $options.openQualitydt && $options.openQualitydt(...args))
  });
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-0a25cdaf"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/index/qt.js.map
