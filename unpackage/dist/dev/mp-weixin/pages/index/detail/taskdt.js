...
const _sfc_main = {
  ...
  methods: {
    async getTaskList(userId, ordertype) {
      common_vendor.index.__f__("log", "at pages/index/detail/taskdt.vue:99", "1");
      try {
        const res = await services_api.api.taskApi.taskList({ userid: userId, ordertype });
        common_vendor.index.__f__("log", "at pages/index/detail/taskdt.vue:102", res);
        ...
        common_vendor.index.__f__("error", "at pages/index/detail/taskdt.vue:115", "获取任务失败", error);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-18adf391"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/index/detail/taskdt.js.map
