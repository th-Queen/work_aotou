...
const _sfc_main = {
  ...
  methods: {
    ...
    async publishTask() {
      common_vendor.index.__f__("log", "at pages/index/release.vue:196", "taskName:", this.taskName);
      if (!this.canPublish)
        return;
      ...
      common_vendor.index.__f__("log", "at pages/index/release.vue:217", "完整的 taskData:", JSON.stringify(taskData, null, 2));
      try {
        ...
        common_vendor.index.__f__("error", "at pages/index/release.vue:225", "API错误", error);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    C: common_vendor.o((...args) => $options.openReleasedt && $options.openReleasedt(...args))
  });
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-aefa05e0"]]);
